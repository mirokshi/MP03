...
public class Utils {
    ...
    public static<E> TableColumn loadTable(ArrayList<E> resultSet, JTable taula, Class<E> classe) {
    ...
    public static<E> TableColumn loadTable(ArrayList<E> resultSet, JTable taula, Class<E> classe, boolean editable) {
    ...
    //Com l'anterior però per treballar en BDs usant un ResultSet
    public static<E> TableColumn loadTable(ArrayList<E> resultSet, JTable taula, Class<E> classe, boolean editable, java.sql.ResultSet resultat) {
        ...
        if (editable) {
            //Utilitzem el model que permet actualitzar la BD des de la taula
            model = new ModelCanvisBD(data, columnNames, resultat);
            //model = new DefaultTableModel(data, columnNames);
        } else {
            model = new NotEditTableModel(data, columnNames);
        }
...
class ModelCanvisBD extends DefaultTableModel {
    ...
    //Actualitzem la fila que ha estat modificada
        ...
        this.addTableModelListener(new TableModelListener() {
            ...
            public void tableChanged(TableModelEvent e) {
                ...
                try {
                    ...
                    //Actualitzem la columna (el mateix passa que li hem de 
                    //sumar 1 a la columna retornada pel TableModel)
                    resultSet.updateObject(column + 1, data);
                    resultSet.updateRow();
                } catch (SQLException ex) {
                    //Logger.getLogger(JFramePelis.class.getName()).log(Level.SEVERE, null, ex);
